...
class RegisterPresenter extends BaseViewPresenter<RegisterView> {
    ...
    @Inject
    RegisterPresenter(Flow flow, ActionBarOwner actionBarOwner, Validator validator, ApiService apiService, JsonSharedPreferencesRepository prefsRepository, PresenterSharedRepository presenterSharedRepository) {
        this.flow = flow;
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                presenterSharedRepository.setCurrentBuzID(curBuzId);
