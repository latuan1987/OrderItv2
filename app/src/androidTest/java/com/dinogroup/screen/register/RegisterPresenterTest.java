...
public class RegisterPresenterTest {
	...
	@Mock PresenterSharedRepository presenterSharedRepository;
	...
	public void before() throws Exception {
		...
		presenter = new RegisterPresenter(flow, actionBarOwner, validator, apiService, prefsRepository, presenterSharedRepository);
